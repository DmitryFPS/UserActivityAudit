...
## 4. Опционально: центральный сервер

Каталог `server/` — **необязательный** модуль для парка ПК (15+ машин, единый portal, escrow). Для автономного сценария не устанавливайте.

---

## 5. Перенос логов на другой ПК
